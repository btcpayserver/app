...
namespace Comrade.Desktop;

public static class StartupExtensions
{
    public static IServiceCollection ConfigureComradeDesktop(this IServiceCollection serviceCollection)
    {
...
public class DesktopDataDirectoryProvider : IDataDirectoryProvider
{
    ...
    {
        return Task.FromResult(GetDirectory("Comrade"));
    }
